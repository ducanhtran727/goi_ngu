...
- Gallery có nút chọn xanh lục, xanh lam, đỏ, nhãn chữ và trạng thái được chọn; đây là minh họa trạng thái đèn, không phải biến thể để đặt mua.
...
- Kiểm tra chọn trạng thái đèn, số lượng và tổng tiền, lỗi form, focus tới trường lỗi, trạng thái gửi và kết quả.
